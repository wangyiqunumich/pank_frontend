...
| has expression | gene | ontology | 60285 | [PanKbase Team](Wait for expression data library link)                | [Pipeline](https://pank-s3-to-share.s3.us-east-1.amazonaws.com/docs/expression_pipeline.pdf), [code](https://github.com/PanKbase/PanKbase-scRNA-seq)  |
| differentially expressed | gene | ontology | 1957 | [PanKbase Team](Wait for DEG data library link)              | [Pipeline](https://pank-s3-to-share.s3.us-east-1.amazonaws.com/docs/deg_pipeline.pdf), [Code](https://www.google.com/url?q=https://github.com/PanKbase/PanKbase-DEG-analysis&sa=D&source=docs&ust=1750170583487441&usg=AOvVaw0Isgr-cuzcsh4-626q3bLv)  |
