...
1. **GTEx Consortium**
   ...
   The Genotype-Tissue Expression (GTEx) project provides a comprehensive atlas of genetic regulatory effects across multiple human tissues. This resource is instrumental in understanding how genetic variation influences gene expression in different tissue types. [GTEx Consortium (2020)](https://www.science.org/doi/pdf/10.1126/science.aaz1776?). 
...
1. **Type 1 Diabetes (T1D) GWAS**
   ...
   A comprehensive GWAS identified multiple genetic loci associated with Type 1 Diabetes, providing insights into the genetic underpinnings of the disease. [ Anna Kriebs (2021)](https://www.nature.com/articles/d42859-021-00006-1?)
