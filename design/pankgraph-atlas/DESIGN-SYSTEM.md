...
| Empty / error state panel | Feature unavailable, no QTL records | 800px max (same as dialogs), corner-large, elevation-1, 32 × 24 padding, centered; 160px illustration → L1 title → L4 supporting text (4px below title) → actions (filled + text, 40px) |
